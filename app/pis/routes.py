...
def new_pi():
    ...
    if form.validate_on_submit():
        post = Ownership(raspi_id=form.raspi_id.data, phone=form.phone_no.data, rangername=form.rangername.data, owner=current_user)
        db.session.add(post)
        db.session.commit()
